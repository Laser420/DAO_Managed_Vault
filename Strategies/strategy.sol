...
//Safetransfer to strategy...
 ...
 // NOTE: The vault strategy contract MUST call an approval for all its assets before calling this function
    ...
    function transferFundsBackFromStrategy() external;

    //Change the strategy address - GOVERANCE
    function changeStrategy(address newStrat) external;
...
contract SillyStategyTemplate {
    ...
    ERC20 asset;
     ...
     modifier onlyVault() {
        require(msg.sender == vaultAddress, "Not the strategy");
        _;
    }
   ...
   ISillyVault vault = ISillyVault(vaultAddress);
