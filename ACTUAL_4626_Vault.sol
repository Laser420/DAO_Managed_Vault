...
contract SSGETH is xERC4626, ReentrancyGuard {
    ...
    function deposit(uint256 assets, address receiver) public override andSync isDeprecated returns (uint256 shares) {
        return super.deposit(assets, receiver);
    }

    /// @notice inlines syncRewards with mints when able
    function mint(uint256 shares, address receiver) public override andSync isDeprecated returns (uint256 assets) {
